...
function Chat() {
  ...
  const { room, username, handleRoomChange, roomList, currentMessage, setCurrentMessage, sendMessage, messageList, isTyping, } = useSocket(); //setIsTyping, isSending, setIsSending
